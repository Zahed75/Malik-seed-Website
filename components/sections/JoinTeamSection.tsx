  ...
  return (
    ...
    <section className="w-full bg-[#F2F7F1] py-10 md:py-16 xl:py-[100px]" id="careers">
      <div className="mx-auto max-w-[1440px] px-4 md:px-8 lg:px-16 xl:px-[100px]">
        ...
        <div className="group relative mx-auto flex w-full max-w-[358px] flex-col items-center justify-between overflow-hidden rounded-[24px] bg-white px-[14px] pt-[24px] pb-[14px] sm:max-w-[480px] md:max-w-[680px] lg:max-w-[920px] xl:h-[490px] xl:max-w-none xl:flex-row xl:rounded-[32px] xl:p-0">
          
          {/* Inner mobile container — Figma: 330x475, gap 32px (Frame 2147229896) */}
          <div className="flex w-full max-w-[330px] flex-col items-center justify-between gap-[32px] sm:max-w-none xl:contents">
            
            {/* Left/Top text content — Mobile: 310x233, gap 24px (Frame 2147229510) | Desktop: 403x301, left:60px, top:95px */}
            <div className="flex w-full max-w-[310px] shrink-0 flex-col items-start justify-between gap-[24px] xl:absolute xl:top-[95px] xl:left-[60px] xl:h-[301px] xl:w-[403px] xl:max-w-none xl:px-0 xl:py-0">
              ...
              <div className="flex w-full flex-col items-start justify-between gap-[24px] xl:h-[252px] xl:w-[403px] xl:gap-[32px]">
                ...
                <div className="relative w-full max-w-[310px] xl:h-[174px] xl:max-w-[403px]">
                  <h2
            ...
            <div className="relative h-[210px] w-full max-w-[330px] overflow-hidden rounded-[20px] bg-white xl:hidden">
              {/* Overflowing team image — Figma: 330x248, left:0, top:-19px (Malik Seeds Team-3 2) */}
              <div className="absolute -top-[19px] left-0 h-[248px] w-full overflow-hidden">
                <OptimizedImage
